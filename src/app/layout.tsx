...
export const metadata: Metadata = {
  title: "1USE - Hip Hop & Trap Artists | Authentic Music",
  description: "Discover raw hip hop and trap music from emerging artists at 1USE. Stream authentic beats, follow your favorite creators, and join the movement.",
  keywords: "hip hop, trap music, rap artists, beats, streaming, independent music",
  metadataBase: new URL("https://1use.music"),
  alternates: {
    canonical: "https://1use.music"
  },
  openGraph: {
    title: "1USE - Hip Hop & Trap Collective",
    description: "Experience authentic hip hop and trap music from rising artists.",
    url: "https://1use.music",
    siteName: "1USE",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764949126051-iqsihkkf.jpg",
      alt: "1USE Hip Hop Collective"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "1USE - Hip Hop & Trap Artists",
    description: "Authentic hip hop and trap music from emerging artists.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764949126051-iqsihkkf.jpg"]
  },
  robots: {
    index: true,
    follow: true
